...
import se.dabox.cocobox.cpweb.state.NewProjectSessionProcessorNg;
...
/**
 * Similar to CreateProjectSessionProcess, but agnostic to web forms (eventually, keeping the form object for now)
 * and does not return RequestTarget but created project.
 *
 * @author Magnus Andersson (magnus.andersson@learnifier.com)
 */

public class CreateProjectSessionProcessorNg implements NewProjectSessionProcessorNg {
    /**
    ...
    private static final Logger LOGGER = LoggerFactory.
            getLogger(CreateProjectSessionProcessorNg.class);
    private static final long serialVersionUID = 1L;
    private final long orgId;

    private List<ProjectProductFailure> failures;

    public CreateProjectSessionProcessorNg(long orgId) {
        this.orgId = orgId;
    }
    ...
    private void activateProjectDesign(RequestCycle cycle, OrgProject project, NewProjectSessionNg nps) {
    ...
    private void addCourseSession(RequestCycle cycle, OrgProject project, NewProjectSessionNg nps) {
        CourseDesignClient cdClient = Clients.getClient(cycle, CourseDesignClient.class);
    ...
    private List<ExtraProductConfig> getExtraConfigItems(RequestCycle cycle, NewProjectSessionNg nps) {
    ...
    private boolean missingExtraParameters(RequestCycle cycle, NewProjectSessionNg nps) {
    ...
    private List<Product> getProjectProducts(RequestCycle cycle, NewProjectSessionNg nps) throws CodecException, ClientFactoryException {
    ...
    private List<Product> getOrgMatProjectProducts(RequestCycle cycle, NewProjectSessionNg nps) {
        ProductDirectoryClient pdClient
                = CacheClients.getClient(cycle, ProductDirectoryClient.class);
    ...
    private List<Product> getDesignProjectProducts(RequestCycle cycle, NewProjectSessionNg nps) {
