 ...
 * @author borg321
 */
@WebModuleMountpoint("/deeplink")
public class DeeplinkModule extends AbstractWebAuthModule {
    ...
    public RequestTarget onEdit(RequestCycle cycle, String strOrgId, String strOrgmatId) {
        ...
        map.put("org", org);
        String formLink = cycle.urlFor(DeeplinkModule.class, "performEdit", strOrgId,
                strOrgmatId);
    ...
    public RequestTarget onPerformEdit(RequestCycle cycle, String strOrgId, String strOrgmatId) {
        ...
        if (!formsess.process()) {
            return new WebModuleRedirectRequestTarget(DeeplinkModule.class, strOrgId, strOrgmatId);
        }
